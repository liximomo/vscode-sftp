...
## ⚠ INFOS <br>
This is the one and only official fork of this extension since @liximomo has set his own to deprecated in favor of mine in the VSCode marketplace. <br>
I've been working hard to fix a lot of things and i've updated more than 30 new releases with lot of improvements and stability fixes and bring new features for two years now. I don't want to rush new features as I prefer to have a long-term stable project. Just so you know, At the start of this year, in January, a new fork of mine has been available from @satiromarra with some new cool features (feel free to try it) but he has removed every mention of our work from @liximomo and I and is not even crediting us or the original work we've done. He's actually not giving a good side of him. I can't always be available to update this project, as of today he has forked my work and is taking all the credit for it without even mentioning @liximomo or me in the README. That's really not the way to do it. <br>
I actually dont mind the fork, I even think that's a great idea and that some of his features are a pretty cool addition but it would be a lot better and easier if we could keep all this nice work centralized in one place. I know for a fact that @satiromarra is ignoring me and other people because he has answered to multiple issues on his repo since I reached to him but is not answering your or my questions. If he isn't able to communicate and do this the right way, that's ok. For the last 6 months I wasn't able to work a lot on the project because of personal reasons and if he was that implicated he would have reached to me in the first place to ask some news about the project instead of ignoring me at the time. I've also a full time job that's taking me like almost 50 hours per week so I can't always be as reactive as I would like. Also I would be more than happy to work with @satiromarra to have the best of our two forks to make one big and better one but as we can all clerly see, this is not going to happen that soon as he's just ignoring us. So for now I'll keep this the only official one and up-to-date as much as I can. <br>
